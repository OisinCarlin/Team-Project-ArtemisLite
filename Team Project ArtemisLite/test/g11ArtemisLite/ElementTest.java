...
/*
 * @Test void testOnLandNull()
 * 
 * Element element = new Element(name, purchasePrice, rentPrice,
 * developmentPrice); Player player = new Player();
 * 
 * //assert true? - mock out private method, call onland, check private method
 * has been called assertEquals(element.onLand(player),
 * attemptPurchaseElement(player)); }
 * 
 * @Test void testOnLandPlayerEqualsOwner() {
 * 
 * Element element = new Element(name, purchasePrice, rentPrice,
 * developmentPrice); Player player = new Player(); element.setOwner(owner);
 * 
 * // set own as player - mockito? assert method has been called
 * assert(System.out.println("You own this element")); }
 * 
 * @Test void testOnLandPlayerElse() {
 * 
 * Element element = new Element(name, purchasePrice, rentPrice,
 * developmentPrice); Player player = new Player();
 * 
